 ...
 * RelatedVideo.tsx
 *
 * Component for displaying related videos in the video player screen.
 * Similar to RelatedArticle but for video content.
 *
          ...
          <View style={styles.statsContainer}>
            {viewCount && (
              <Text
                style={[
                  styles.stats,
                  { fontSize: getArticleTextSize(12, textSize) },
                ]}
              >
